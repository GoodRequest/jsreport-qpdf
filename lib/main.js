...
console.log(process.env.QPDF_PATH)
module.exports = (reporter, definition) => {
  ...
  reporter.documentStore.registerComplexType('PdfPasswordType-qpdf', {
    password: { type: 'Edm.String' }
  })
  ...
  if (reporter.documentStore.model.entityTypes.TemplateType) {
    ...
    reporter.documentStore.model.entityTypes.TemplateType.pdfPasswordQpdf = { type: 'jsreport.PdfPasswordType-qpdf', schema: { type: 'null' } }
  ...
  reporter.initializeListeners.add('pdf-qpdf', async (req, res) => {
